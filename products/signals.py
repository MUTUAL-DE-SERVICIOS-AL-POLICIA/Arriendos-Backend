...
def log_create_rate(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        try:
            ...
            business_logger.error(f"[RATE] Audit record failed: {e}")
...
def log_create_hour_range(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        try:
            ...
            business_logger.error(f"[HOUR_RANGE] Audit record failed: {e}")
...
def log_create_product(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        try:
            ...
            business_logger.error(f"[PRODUCT] Audit record failed: {e}")
...
def log_create_price(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        try:
            ...
            business_logger.error(f"[PRICE] Audit record failed: {e}")
...
def log_create_price_additional_hour(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        try:
            ...
            business_logger.error(f"[PRICE_ADDITIONAL_HOUR] Audit record failed: {e}")
